...
export default async function handler(req, res) {
  ...
  try {
    // keep your previous defaults for compatibility
    const { q = "", region = "US", limit = "12", slim = "1", lang } = req.query;
    ...
    const r = await yt("search", {
      ...
      maxResults,
      regionCode: region,
      relevanceLanguage: lang || "en" // was hardcoded "en"; now override-able
    }, key);
